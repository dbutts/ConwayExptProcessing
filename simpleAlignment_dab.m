...
addpath(genpath([codedir 'ConwayExptProcessing/Dependencies/']));
...
REW_ON_ts = events.timeStamps(events.strobeNumber == 32765);  
REW_OFF_ts = events.timeStamps(events.strobeNumber == 32764); 
