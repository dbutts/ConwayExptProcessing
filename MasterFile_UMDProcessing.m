...
stimpath = '/media/felix/Internal_1/Data/BevilColor/Cloudstims_calib_01_2022';

% Switch into data directory
dirpath = '/media/felix/Internal_1/Data/BevilColor';
cd(dirpath)

% this is the name of the experiment you want to run
filenameP = '220930_150817_Jacomo'; 
...
ks.FilePath = [dirpath filenameP filesep 'kilosorting_stitch' filesep]; 

[ExptTrials, ExptInfo] = ExtractAndAlignData( filenameP, dirpath, which_computer, ks, ET_type, is_cloud ); 
