...
%%
filenameP = '220713_103737_Jacomo';
...
%%
ksFilePath= ['/media/felix/Internal_1/Data/BevilColor/' filenameP '/kilosorting_Utah_1to16/'];
...
spk_clusters = [spk_clusters; readNPY([ksFilePath 'spike_clusters.npy'])+nclusts];
%%
ksFilePath= ['/media/felix/Internal_1/Data/BevilColor/' filenameP '/kilosorting_Utah_17to32/'];
...
spk_info.Rating = [spk_info.Rating; spk_info_temp.r];
spk_info.amp = [spk_info.amp; spk_info_temp.amp];
spk_info.ch = [spk_info.ch; spk_info_temp.ch+16+160];
spk_info.depth = [spk_info.depth; spk_info_temp.depth];
spk_info.fr = [spk_info.fr; spk_info_temp.fr];
spk_info.group = [spk_info.group; spk_info_temp.group];
spk_info.n_spikes = [spk_info.n_spikes; spk_info_temp.n_spikes];
...
spk_clusters = [spk_clusters; readNPY([ksFilePath 'spike_clusters.npy'])+nclusts];
%%
ksFilePath= ['/media/felix/Internal_1/Data/BevilColor/' filenameP '/kilosorting_Utah_33to48/'];
...
spk_info.Rating = [spk_info.Rating; spk_info_temp.r];
spk_info.amp = [spk_info.amp; spk_info_temp.amp];
spk_info.ch = [spk_info.ch; spk_info_temp.ch+32+160];
spk_info.depth = [spk_info.depth; spk_info_temp.depth];
spk_info.fr = [spk_info.fr; spk_info_temp.fr];
spk_info.group = [spk_info.group; spk_info_temp.group];
spk_info.n_spikes = [spk_info.n_spikes; spk_info_temp.n_spikes];
...
%%
ksFilePath= ['/media/felix/Internal_1/Data/BevilColor/' filenameP '/kilosorting_Utah_49to64/'];
...
spk_clusters = [spk_clusters; readNPY([ksFilePath 'spike_clusters.npy'])+nclusts];
%%
ksFilePath= ['/media/felix/Internal_1/Data/BevilColor/' filenameP '/kilosorting_Utah_65to80/'];
...
spk_info.Rating = [spk_info.Rating; spk_info_temp.r];
spk_info.amp = [spk_info.amp; spk_info_temp.amp];
spk_info.ch = [spk_info.ch; spk_info_temp.ch+64+160];
spk_info.depth = [spk_info.depth; spk_info_temp.depth];
spk_info.fr = [spk_info.fr; spk_info_temp.fr];
spk_info.group = [spk_info.group; spk_info_temp.group];
spk_info.n_spikes = [spk_info.n_spikes; spk_info_temp.n_spikes];
...
%%
ksFilePath= ['/media/felix/Internal_1/Data/BevilColor/' filenameP '/kilosorting_Utah_81to96/'];
...
spk_info.Rating = [spk_info.Rating; spk_info_temp.r];
spk_info.amp = [spk_info.amp; spk_info_temp.amp];
spk_info.ch = [spk_info.ch; spk_info_temp.ch+80+160];
spk_info.depth = [spk_info.depth; spk_info_temp.depth];
spk_info.fr = [spk_info.fr; spk_info_temp.fr];
spk_info.group = [spk_info.group; spk_info_temp.group];
spk_info.n_spikes = [spk_info.n_spikes; spk_info_temp.n_spikes];
