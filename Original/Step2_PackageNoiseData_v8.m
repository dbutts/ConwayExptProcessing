...
% this script outputs a processed HDF5 file containing the cloud data

%path to the stimulus frames in this current calibration:
stimFilePath = '/media/felix/Internal_1/Data/BevilColor/Cloudstims_calib_01_2022/';
% this data is also in the dataserver in Data2/Conway/Cloudstims_calib_01_2022/';
%% params
...
targ_stimtype=8; % 8 means we look at clouds
...
%% test contents of ExperimentRecording
%/{
...
%cur_use_inds = valid_data(1:100000); % if running into memory issues, try only first chunk
cur_use_inds(end-10:end)=[];
%%
