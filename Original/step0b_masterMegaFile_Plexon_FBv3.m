function [] = step0b_masterMegaFile_Plexon_FBv3(datPath, fs, nCh, probeGeometry, ops, Nfilt)
...
%ops.chanMap             = fullfile('/home/felix/Dropbox/Project_BevilColor/Kilosort_config/Utah_chanMap.mat');
% sample rate
ops.fs = fs;  
...
ops.NT                  = 2*8*1024+ ops.ntbuff; % must be multiple of 32 + ntbuff. This is the batch size (try decreasing if out of memory). default: 2*64*1024+ ops.ntbuff;  

ops.whiteningRange      = inf; % number of channels to use for whitening each channel. default=24;
