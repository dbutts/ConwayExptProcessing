...
filenameP = '220722_144441_Jacomo'; ET_Eyelink=1; spk_offset=0; % set to 2 for 0616 to 0709 for eyelink with monoc-only traces
%filenameP = '220207_111324_Jacomo'; ET_Eyelink=0; spk_offset=0; % set to 2 for 0616 to 0709 for eyelink with monoc-only traces
%filenameP = '230331_144125_Jacomo'; spk_offset=58.352; ET_Eyelink=3; % set to 2 for 0616 to 0709 for eyelink with monoc-only traces
%filenameP = '230328_165026_Jacomo'; spk_offset=67.442; ET_Eyelink=3; % set to 2 for 0616 to 0709 for eyelink with monoc-only traces
