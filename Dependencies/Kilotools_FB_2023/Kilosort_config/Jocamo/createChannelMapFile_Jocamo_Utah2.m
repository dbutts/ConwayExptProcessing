...
fs = 40000; % sampling frequency
save('/home/felix/Dropbox/Project_BevilColor/Kilosort_config/Utah_chanMap_nogroup.mat', ...
    'chanMap','connected', 'xcoords', 'ycoords', 'kcoords', 'chanMap0ind', 'fs')
%%
clear all
load('/home/felix/Dropbox/Project_BevilColor/Kilosort_config/Utah_chanMap.mat')
cur_indx=[1 48];
...
fs = 40000; % sampling frequency
save(['/home/felix/Dropbox/Project_BevilColor/Kilosort_config/Utah_chanMap_' num2str(cur_indx(1)) 'to' num2str(cur_indx(2)) '.mat'], ...
    'chanMap','connected', 'xcoords', 'ycoords', 'kcoords', 'chanMap0ind', 'fs')
%%
clear all
load('/home/felix/Dropbox/Project_BevilColor/Kilosort_config/Utah_chanMap_nogroup.mat')
cur_indx=[81 96];
...
fs = 40000; % sampling frequency
save(['/home/felix/Dropbox/Project_BevilColor/Kilosort_config/Utah_chanMap_' num2str(cur_indx(1)) 'to' num2str(cur_indx(2)) 'nogroup.mat'], ...
    'chanMap','connected', 'xcoords', 'ycoords', 'kcoords', 'chanMap0ind', 'fs')
%%
